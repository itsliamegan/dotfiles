...
When Emacs creates a split, usually it creates it horizonally. Given
that with 16:9 displays, I usually have more horizontal space than
vertical, I'd rather create a vertical split by default.
